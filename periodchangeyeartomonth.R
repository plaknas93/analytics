...
ts1=ts(admission, start = c(2016,7),end=c(2016,10),frequency = 1)
ts1
plot(ts1)
?ts
...
#monthly Sales Data  52 weeks in a year
sales4 = ceiling(runif(12, 50,100))
(monthlyTSdata = ts(sales4, start=c(2017,3), frequency=12))
monthlyTSdata
plot(monthlyTSdata)
start(monthlyTSdata); end(weeklyTSdata) ;frequency(weeklyTSdata)
