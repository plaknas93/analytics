...
as.Date('2018-04-29') + 1:15
as.Date('2018-04-29') + seq(1,10,2)
...
format(Sys.Date(),"%A")
format(as.Date("10-02-1993", "%d-%m-%Y"),"%A") #Finding your birthday day
...
cat(format(course, format="%B-%d")) #Cat is a print command
months(course)
weekdays(course)
quarters(course)
...
x
y=c(1,2,3,6,7)
x1=seq(1,20,length.out = 3)
x1
x2=seq(1,20,along.with = y )
x2
?seq
